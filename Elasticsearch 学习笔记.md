...
<font color="red">这类似于 MySql 的分库分表，只不过 Mysql 分库分表需要借助第三方组件而 ES 内部自身实现了此功能。</font>
...
- 特定优化：是ES官方专为 Elasticsearch脚本编写而设计。
...
运行结果：会返回所有查询结果，同时会返回聚合查询值的数量（这一定与mysql的group by还是存在差异）

![image-20210223195156154](https://cdn.jsdelivr.net/gh/kender1314/NotePicture/20210223195204.png)
...
![image-20210223201505876](https://cdn.jsdelivr.net/gh/kender1314/NotePicture/20210223201507.png)
...
注：*自elasticsearch 6.7开始 ，如果使用index使用type执行映射，就会提示需要在url中需要添加include_type_name参数，如果不使用type，就能正常运行。*
...
- geo_distance：聚合统计距离用户 xxx km 以内结果的数量
...
![image-20200921145550599](https://cdn.jsdelivr.net/gh/kender1314/NotePicture/20200921145653.png)
